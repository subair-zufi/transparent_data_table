...
class TransparentDataTable extends StatefulWidget {
  ///
  ...
  @override
  TransparentDataTableState createState() => TransparentDataTableState();
}

/// Holds the state of a [TransparentDataTable].
///
/// The table can be programmatically paged using the [pageTo] method.
class TransparentDataTableState extends State<TransparentDataTable> {
  ...
  @override
  void didUpdateWidget(TransparentDataTable oldWidget) {
